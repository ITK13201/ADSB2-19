...
(Ver.1.3.1,Ver.1.3.2,Ver.1.3.3について)
更に高速化しました

Ver.1.4について
多数派で「正しい列」を求める際、1回でも正しくないことが判明した列は多数決にその後も入れないようにしました
また、全ての列が正しくない状態になってしまった時にMの値に関わらずそこまでで打ち切って判定を行うようにしました

Ver.1.5について
なんか他の班がもっと速かったので気合で更に20%くらい実行時間を減らしました(編集距離の計算で2乗かかっているのが原因っぽい)
編集距離が0の組が見つかったら即打ち切りするようにしました
可読性が終わったのでそのうちコメントで説明を入れます

Ver.1.6について
挿入・欠損が同時に起こった場合(置換のように見える)も考慮するようにしました
編集距離の計算の順番を変更して高速化を行いました
(Ver.1.6.1について)
少しだけ高速化されました(多分)
(Ver.1.6.2について)
バグを修正しました
